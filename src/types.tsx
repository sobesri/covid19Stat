...
export const LOCAL_TIMELINE: CaseSummary[] = [
  ...
  { date: new Date(2020, 4, 11), recovered: 343, deaths: 9, confirmed: 869 },
  { date: new Date(2020, 4, 12), recovered: 366, deaths: 9, confirmed: 889 },
  { date: new Date(2020, 4, 13), recovered: 382, deaths: 9, confirmed: 915 },
  { date: new Date(2020, 4, 14), recovered: 445, deaths: 9, confirmed: 925 },
  { date: new Date(2020, 4, 15), recovered: 477, deaths: 9, confirmed: 935 },
  { date: new Date(2020, 4, 16), recovered: 520, deaths: 9, confirmed: 960 },
  { date: new Date(2020, 4, 17), recovered: 538, deaths: 9, confirmed: 981 },
  { date: new Date(2020, 4, 18), recovered: 559, deaths: 9, confirmed: 992 },
  { date: new Date(2020, 4, 19), recovered: 569, deaths: 9, confirmed: 1027 },
  { date: new Date(2020, 4, 20), recovered: 584, deaths: 9, confirmed: 1028 },
  { date: new Date(2020, 4, 21), recovered: 604, deaths: 9, confirmed: 1055 },
  { date: new Date(2020, 4, 22), recovered: 620, deaths: 9, confirmed: 1068 },
  { date: new Date(2020, 4, 23), recovered: 660, deaths: 9, confirmed: 1089 },
  { date: new Date(2020, 4, 24), recovered: 674, deaths: 9, confirmed: 1141 },
  { date: new Date(2020, 4, 25), recovered: 695, deaths: 9, confirmed: 1182 },
  { date: new Date(2020, 4, 26), recovered: 712, deaths: 10, confirmed: 1319 },
  { date: new Date(2020, 4, 27), recovered: 732, deaths: 10, confirmed: 1469 },
  { date: new Date(2020, 4, 28), recovered: 745, deaths: 10, confirmed: 1530 },
  { date: new Date(2020, 4, 29), recovered: 754, deaths: 10, confirmed: 1558 },
  { date: new Date(2020, 4, 30), recovered: 801, deaths: 10, confirmed: 1620 },
  { date: new Date(2020, 4, 31), recovered: 801, deaths: 10, confirmed: 1620 },
];
